			...
			<nav class="navbar navbar-default" role="navigation">
				...
				<div class="collapse navbar-collapse navbar-ex1-collapse">
					...
					<ul class="nav navbar-nav navbar-right" id="menutren">  
						...
						<li><a href="{{ asset('/') }}">Đơn Hàng</a></li>   									
						<li><a href="{{ asset('/admin/nhan-vien') }}">Nhân Viên</a></li>   									
						<li><a href="{{ asset('/') }}">Thống Kê Ca</a></li>   									
						<li><a href="{{ asset('/admin/ung-vien') }}">Ứng Viên</a></li>   									
						<li><a href="{{ asset('/admin/su-kien') }}">Sự Kiện</a></li>   									
						<li><a href="{{ asset('/') }}">Báo Cáo</a></li>   									
						<li><a href="{{ asset('/admin/danh-gia') }}">Đánh Giá</a></li>   									
						<li><a href="{{ asset('/') }}">Đổi Mật Khẩu</a></li>   									
						<li><a href="{{ asset('/dang-nhap') }}">Đăng Xuất</a></li>  									
